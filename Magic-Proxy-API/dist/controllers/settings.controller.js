...
let SettingsController = class SettingsController {
    constructor(settingsService, magicProxyService, response) {
    ...
    getSettings() {
        return __awaiter(this, void 0, void 0, function* () {
            return this.response.build(yield this.settingsService.findAll());
        });
    }
    addSetting(data) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.settingsService.insert(data);
    ...
    deleteSetting(id) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.settingsService.remove(id);
            yield this.magicProxyService.reloadProxy();
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [settings_model_1.SettingsModel]),
    __metadata("design:returntype", Promise)
], SettingsController.prototype, "addSetting", null);
__decorate([
    (0, common_1.Delete)(),
    (0, roles_decorator_1.Roles)(roles_enum_1.Roles.Manager),
    openapi.ApiResponse({ status: 200, type: Object }),
