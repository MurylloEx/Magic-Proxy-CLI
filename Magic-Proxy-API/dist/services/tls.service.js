...
let TlsService = class TlsService {
    ...
    updateOne(id, user) {
        return __awaiter(this, void 0, void 0, function* () {
            let found = yield this.Tls.findOne(id);
            if (!found)
                return null;
            yield this.Tls.update({ id }, user);
            return this.Tls.merge(found, user);
        });
    }
    insert(data) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.Tls.save(data);
        });
    }
    remove(id) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.Tls.delete(id);
        });
    }
};
TlsService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(tls_model_1.TlsModel)),
